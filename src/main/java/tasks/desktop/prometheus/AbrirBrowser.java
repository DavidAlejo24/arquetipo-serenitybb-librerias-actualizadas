...
public class AbrirBrowser implements Task   {
    ...
    public <T extends Actor> void performAs(T actor){
        ...
        try {
            ...
            existeImg = screen.exists(browserIcon, 5) != null;
            Assert.assertTrue("No se encontro el icono de google Chrome", existeImg);
            screen.click(browserIcon);

            existeImg = screen.exists(addressBar, 5) != null;
            Assert.assertTrue("No se encontro la barra de busqueda" , existeImg);
            ...
            //screen.click(addressBar);
            /*
            if (screen.wait(addressBar, 5) != null) { // espera hasta 5 segundos
                screen.click(addressBar);
                screen.type("https://www.google.com\n");
                System.out.println("Interacción con la Barra de busqueda exitosa");
            } else {
                throw new AssertionError("Interacción con la Barra de busqueda fallida");
            }
